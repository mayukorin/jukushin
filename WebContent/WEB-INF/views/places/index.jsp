...
<c:import url="/WEB-INF/views/layout/app.jsp">
    <c:param name="content">
                ...
                <c:choose>
                    ...
                    <c:otherwise>
                        ...
                        <tr class="row2">
                            ...
                            <td class="place_act"><c:out value="${i1.remain}" /></td>
                            <td class="place_action"><a
                                href="<c:url value='/chart/bo'/>">他の年と比較する</a></td>
                        </tr>
                    </c:otherwise>
                </c:choose>
                        ...
                        <c:choose>
                            <c:when test="${mm == 0 }">
                                <tr class="row2">
                                    ...
                                    <td class="place_action"><c:choose>
                                            <c:when test="${i1.mita_a > 0 }">
                                                <p>
                                                    <a href="<c:url value='/places/circle?id=0'/>">図で見る</a>
                                                </p>
                                            </c:when>
                                            <c:otherwise>
                                なし
                            ...
                            <tr class="row${status.count % 2 }">
                                ...
                                <c:choose>
                                    ...
                                    <c:otherwise>
                                        ...
                                        <td class="place_act2"><c:choose>
                                                <c:when
                                                    test="${pl.act == 0  or pl.place.name=='三田ラック' or pl.place.name=='研究室棟'}">
                                                    <c:choose>
                                ...
                                <td class="place_action"><a
                                    href="<c:url value='/places/show?id=${pl.id}'/>">詳細を見る</a></td>
                            </tr>
                        </c:when>
                                ...
                                <tr class="row2">
                                    ...
                                    <td class="place_action"><c:choose>
                                            <c:when test="${i1.hiyoshi_a > 0 }">
                                                <p>
                                                    <a href="<c:url value='/places/circle?id=1'/>">図で見る</a>
                                                </p>
                                            </c:when>
                                            <c:otherwise>
                                   なし
                            ...
                            <tr class="row2">
                                ...
                                <c:choose>
                                    ...
                                    <c:otherwise>
                                        ...
                                        <c:choose>
                                            <c:when
                                                test="${plm.act==0 or plm.place.name=='日吉ラック' or plm.place.name=='矢上ラック'}">
                                                <c:choose>
                                ...
                                <td class="place_action"><a
                                    href="<c:url value='/places/show?id=${plm.id}'/>">詳細を見る</a></td>
                            </tr>
                        </c:when>
                    ...
                    <c:choose>
                        <c:when test="${decision == 0}">
                            <tr class="row${status.count % 2 }">
                                ...
                                <td class="place_action"><a
                                    href="<c:url value='/places/show?id=${plo.id}'/>">詳細を見る</a></td>
        ...
        <c:choose>
            <c:when test="${decision == 0}">
                <c:if test="${i1.remain > 0}">
                    <p>
                        <a href="<c:url value='/places/new?flag=0'/>">新規配布場所の登録</a>
                    </p>
                </c:if>
                <p>
                    <a href="<c:url value='/places/decide'/>"><button type="submit">日吉と三田の部数を確定させる</button></a>
                </p>
            </c:when>
            <c:otherwise>
                <c:if test="${hh > 0}">
                    <p>
                        <a href="<c:url value='/places/new?flag=2'/>">日吉からの新規配布場所の登録</a>
                    </p>
                </c:if>
                <c:if test="${mm > 0}">
                    <p>
                        <a href="<c:url value='/places/new?flag=1'/>">三田からの新規配布場所の登録</a>
                    </p>
                </c:if>
        ...
        <p>
            <a href="<c:url value='/newspapers/index'/>"><c:out
                    value="${i1.newspaper.year}年度新聞ハケ率一覧に戻る" /></a>
        </p>
    </c:param>
</c:import>
