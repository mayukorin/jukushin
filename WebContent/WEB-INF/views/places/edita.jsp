...
<c:import url="/WEB-INF/views/layout/app.jsp">
    <c:param name="content">
        <c:choose>
            <c:when test="${i2 != null }">
                ...
                <form method="POST" action="<c:url value='/places/updata'/>">
                    ...
                    <br />
                    <br /> <label for="aim">配布目標数</label><br />
                    <c:out value="${i2.aim}" />
                    <br />
                    <br /> <label for="act">実際配布数</label><br /> <input type="number"
                        name="act" value="${i2.act}" /> <br />
        ...
        <p>
            <a href="<c:url value="/place/index"/>">${i2.newspaper.month}月のハケ状況一覧に戻る</a>
    </c:param>
</c:import>