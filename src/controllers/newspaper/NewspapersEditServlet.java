...
/**
 * Servlet implementation class NewspapersEditServlet
 */
@WebServlet("/newspapers/edit")
public class NewspapersEditServlet extends HttpServlet {
    private static final long serialVersionUID = 1L;

    /**
     * @see HttpServlet#HttpServlet()
     */
    public NewspapersEditServlet() {
        super();
